...
namespace Warframe
{
    public class IncidentWorker_VoidSon : IncidentWorker
    {
        ...
        protected override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            string text = TranslatorFormattedStringExtensions.Translate("VoidSonWOBJText", randomInRange);
        ...
        private bool TryFindTile(out int tile)
        {
            ...
            return TileFinder.TryFindNewSiteTile(out tile, voidSonQuestSiteDistanceRange.min, voidSonQuestSiteDistanceRange.max, false, TileFinderMode.Near,-1,false);
        }
