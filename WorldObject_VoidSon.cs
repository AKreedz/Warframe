...
namespace Warframe
{
    public class WorldObject_VoidSon : WorldObject
    {
        ...
        {
            return CaravanArrivalActionUtility.GetFloatMenuOptions<CaravanArrivalAction_VoidSon>(() => CaravanArrivalAction_VoidSon.CanVisit(caravan, this), () => new CaravanArrivalAction_VoidSon(this),
                TranslatorFormattedStringExtensions.Translate("VisitVoidSon", this.Label), caravan, this.Tile, this);
        }
        ...
        {
            Find.LetterStack.ReceiveLetter("LetterLabelVoidSon_Fail".Translate(), this.GetLetterText(
                TranslatorFormattedStringExtensions.Translate("LetterVoidSon_Fail", caravan.pawns[0].LabelCap)
        ...
        private void Outcome_Success(Caravan caravan)
        {
            ...
            Find.LetterStack.ReceiveLetter("LetterLabelVoidSon_Success".Translate(), this.GetLetterText(
                TranslatorFormattedStringExtensions.Translate("LetterVoidSon_Success", caravan.pawns[0].LabelCap)
